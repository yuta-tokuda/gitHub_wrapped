    ...
    >
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <input
          ...
          className="h-12 w-full rounded-md border border-border/70 bg-card/75 px-4 text-base text-card-foreground outline-none backdrop-blur ring-offset-background placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring"
